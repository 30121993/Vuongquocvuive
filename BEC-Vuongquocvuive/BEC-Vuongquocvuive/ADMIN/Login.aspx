<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BEC_Vuongquocvuive.ADMIN.Login" %>
...
<html lang="en">
    ...
    <body id="login-body">
        ...
        <div id="login">
            <form id="loginform" class="form-vertical no-padding no-margin" action="Checklogin.aspx?ac=login" method="post"/>
            <div class="lock">
                <i class="icon-lock"></i>
            </div>
            <div class="control-wrap">
                <h4>User Login</h4>
                <p class="loginerror"><asp:Literal runat="server" ID="loginerror"></asp:Literal></p>
